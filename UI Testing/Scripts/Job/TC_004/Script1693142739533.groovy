...
WebUI.click(findTestObject('Object Repository/Page_OSS Workflow Engine/Button Jobs'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OSS Workflow Engine/Link To Project'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OSS Workflow Engine/th_Job Key'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OSS Workflow Engine/th_Job Type'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OSS Workflow Engine/th_State'), 0)
